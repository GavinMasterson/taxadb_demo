...
GISD_query <- read_delim("amrep_gisd_Feb2020.csv", 
                         trim_ws = TRUE, 
                         delim = ";") %>%
              .[,-8] %>% 
              separate(Species, 
...
data_2006 <- read_csv("rep_survey_2006.csv")
